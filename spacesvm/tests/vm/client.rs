...
pub struct Client {
    inner: avalanche_types::proto::vm::vm_client::VmClient<Channel>,
...
impl Client {
    pub fn new(
        client_conn: Channel,
    ) -> Box<dyn avalanche_types::subnet::rpc::common::vm::Vm + Send + Sync> {
...
#[tonic::async_trait]
impl avalanche_types::subnet::rpc::common::vm::Vm for Client {
    async fn initialize(
        &mut self,
        _ctx: Option<avalanche_types::subnet::rpc::context::Context>,
        _db_manager: Box<
            dyn avalanche_types::subnet::rpc::database::manager::Manager + Send + Sync,
        >,
        genesis_bytes: &[u8],
        _upgrade_bytes: &[u8],
        _config_bytes: &[u8],
        _to_engine: mpsc::Sender<avalanche_types::subnet::rpc::common::message::Message>,
        _fxs: &[avalanche_types::subnet::rpc::common::vm::Fx],
        _app_sender: Box<
            dyn avalanche_types::subnet::rpc::common::appsender::AppSender + Send + Sync,
        >,
    ) -> Result<()> {
        // memdb wrapped in rpcdb
        let db = avalanche_types::subnet::rpc::database::rpcdb::server::Server::new(
        ...
        let versiondb_servers = avalanche_types::proto::vm::VersionedDbServer {
        ...
        let request = avalanche_types::proto::vm::InitializeRequest {
            network_id: 0,
    ...
    async fn set_state(&self, _state: avalanche_types::subnet::rpc::snow::State) -> Result<()> {
        // TODO:
        Ok(())
    }
    ...
    async fn create_static_handlers(
        &mut self,
    ) -> Result<HashMap<String, avalanche_types::subnet::rpc::common::http_handler::HttpHandler>>
    {
        let resp = self
            .inner
            .create_static_handlers(avalanche_types::proto::google::protobuf::Empty {})
            .await
            .map_err(|e| {
                Error::new(
                    ErrorKind::Other,
        ...
        for h in resp.handlers.iter() {
            let lock_option =
                avalanche_types::subnet::rpc::common::http_handler::LockOptions::try_from(
                    h.lock_options,
                )
    ...
    ) -> Result<HashMap<String, avalanche_types::subnet::rpc::common::http_handler::HttpHandler>>
    {
        let resp = self
            .inner
            .create_handlers(avalanche_types::proto::google::protobuf::Empty {})
            .await
            .map_err(|e| {
                Error::new(
                    ErrorKind::Other,
...
#[tonic::async_trait]
impl avalanche_types::subnet::rpc::health::Checkable for Client {
...
#[tonic::async_trait]
impl avalanche_types::subnet::rpc::common::vm::Connector for Client {
...
#[tonic::async_trait]
impl avalanche_types::subnet::rpc::common::apphandler::AppHandler for Client {
